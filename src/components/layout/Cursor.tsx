...
export function Cursor() {
    ...
    return (
        <div aria-hidden className="pointer-events-none fixed inset-0 z-80 mix-blend-difference">
            <div
                ref={ringRef}
                className="absolute top-0 left-0 h-10 w-10 rounded-full border border-white/70 opacity-0 transition-opacity duration-300 will-change-transform"
            />
        </div>
    );
}
