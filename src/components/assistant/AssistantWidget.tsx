        ...
        <AssistantRuntimeProvider runtime={runtime}>
            <ToolScope>
                <section
                    ...
                    hidden={!open}
                    className="panel-in flex h-[min(32rem,70vh)] w-[min(22rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-2xl border border-line bg-paper shadow-[0_24px_60px_-28px_rgba(21,23,28,0.35)]"
                >
                    <header className="flex items-center justify-between border-line border-b px-4 py-3">
                        <p className="text-sm font-bold text-ink">포트폴리오 안내</p>
